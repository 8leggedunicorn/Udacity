...
<head>
    ...
    <link href="/content/v/4e3f994e938b/kaggle/favicon.ico" rel="shortcut icon" type="image/x-icon" />
        ...
        <meta name="keywords" content="Kaggle, data science, big analytics, data mining, forecasting, statistics, prediction, bioinformatics, competitions, contests, crowdsourced analytics" />
            ...
            <link rel="stylesheet" href="/content/v/856a8483cddd/shared/css/base.less" type="text/css" />
...
<input name="__RequestVerificationToken" type="hidden" value="PT1U_K0L6erWvtdOP9S12atC9aqnjOmegI5FyW9ci9HH6pDhUVISi20Z2ZaTcyEU1FD-DXsLnYfoBRVccTSF9keF_aA1" />    <input id="signinjs" type="hidden" name="JavaScriptEnabled" value="false" />    
</form>
<script type="text/javascript">
