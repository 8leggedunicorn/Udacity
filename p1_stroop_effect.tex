...
looking at the two histogram graphs, figures \ref{fig:ICS-histogram} and
figures \ref{fig:CCS-histogram}, it becomes very clear that both are heavily
...
thumb of thirty, and as such the general shape of the distribution isn't
obvious, nor is the Central Limit Theorem of use.  So over generalizing is a
bit too easy at this point, however even after removing the outliers in the ICS
case, please see \autoref{fig:ICS-no-outliers-histogram}, it is difficult to
come to any definitvie conclusion about the distribution - only that the times
are greater than the CCS data set.
\begin{figure}[H]
  \centering
